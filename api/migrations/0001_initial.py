    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('continent', models.CharField(max_length=50, unique=True, verbose_name='Continent')),
            ],
            options={
                'ordering': ('continent',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso_code', models.CharField(max_length=5, unique=True, verbose_name='Country Iso Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='country_data', to='api.country')),
            ],
            options={
                'ordering': ('country',),
            },
