...
df = pd.read_csv('/app/sample.csv', usecols=continent_list)
df2 = pd.read_csv('/app/sample.csv', usecols=country_list)
df3 = pd.read_csv('/app/sample.csv', parse_dates=['date'])
